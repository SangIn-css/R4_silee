...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SPI1_SCK_ETHERNET_PA05_Pin|SPI1_MISO_ETHERNET_PA06_Pin|SPI1_MOSI_ETHERNET_PA07_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB13     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, SPI2_MISO_TDC_PC02_Pin|SPI2_MOSI_TDC_PC03_Pin);

    HAL_GPIO_DeInit(SPI2_SCLK_TDC_PB13_GPIO_Port, SPI2_SCLK_TDC_PB13_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC11     ------> SPI3_MISO
    */
    HAL_GPIO_DeInit(GPIOC, SPI3_MOSI_BIASCTRL_PC01_Pin|SPI3_SCLK_BIASCTRL_PC10_Pin|GPIO_PIN_11);
